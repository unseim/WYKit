...
+ (WYNetManager *)sharedWYNetManager
{
    ...
    static id sharedWYNetManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        sharedWYNetManager = [[super allocWithZone:NULL] init];
    });
    return sharedWYNetManager;
}

+ (instancetype)allocWithZone:(struct _NSZone *)zone
{
    return [self sharedWYNetManager];
}
                                ...
                                progress:(WYDownloadProgress)progress
{
    ...
    WYURLSessionTask *sessionTask = nil;
    
    if (type == WYHttpRequestTypeGet)
    {
    ...
    else if (type == WYHttpRequestTypePost)
    {
    ...
    else if (type == WYHttpRequestTypePut)
    {
    ...
    else if (type == WYHttpRequestTypeDelete)
    {
    ...
    [manager setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status) {
        ...
        switch (status)
        {
            case AFNetworkReachabilityStatusUnknown:
                ...
                WYNetManagerShare.netWorkStatu = WYNetworkStatusUnknown;
                break;
